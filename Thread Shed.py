...
for datapoint in daily_transactions:
  daily_transactions_split.append(datapoint.split(':'))
...
for datapoint in transactions_clean:
  customers.append(datapoint[0])
  sales.append(datapoint[1])
  thread_sold.append(datapoint[2])
total_sales = 0
